    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in-up">
          {/* Elementor Badge */}
          <div className="inline-flex items-center bg-elementor-pink/20 border border-elementor-pink/30 rounded-full px-6 py-2 mb-8">
            <div className="w-8 h-8 bg-elementor-pink rounded-lg flex items-center justify-center mr-3">
              <span className="text-white font-bold text-sm">E</span>
            </div>
            <span className="text-elementor-pink font-semibold font-poppins">
              Spesialis Website Elementor Pro
            </span>
          </div>
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-white/90 mb-8 max-w-4xl mx-auto leading-relaxed font-inter">
            ...
            yang bisa Anda edit sendiri dengan mudah - tanpa coding!
          </p>
